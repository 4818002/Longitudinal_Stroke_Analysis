...
cor.variables<-c("GENDER","T1AGE","RACE1","ETHNICITY","YEARSEDU","T0IMRD","T0DLRC","T0SER7","T0VOCAB","T0MSTOT","T0CESD","T0ADLA","T0MOBILA","T0LGMUSA","T0GROSSA","T0ATOTN","T0BMI","T0HIBP","T0DIAB","T0LUNG","T0CANCR","T0HEART","T0PSYCH","T1IMRD","T1DLRC","T1SER7","T1VOCAB","T1MSTOT","T1CESD","T1ADLA","T1MOBILA","T1LGMUSA","T1GROSSA","T1ATOTN","T1BMI","T1PSYCH","T3_DefAlive") #you can add more
...
# Multiple regression
Mul_reg1 <- glm(T3ADLA ~ chronic+GENDER+T1AGE+RACE1+ETHNICITY+YEARSEDU+T0IMRD+T0DLRC+T0SER7+T0VOCAB
                +T0MSTOT+T0CESD+T0ADLA+T0MOBILA+T0LGMUSA+T0GROSSA+T0ATOTN+T0BMI+T0HIBP+T0DIAB+T0LUNG
                +T0CANCR+T0HEART+T0STROK+T0PSYCH+T1IMRD+T1DLRC+T1SER7+T1VOCAB+T1MSTOT+T1CESD+T1ADLA
...
predict(log_reg1,   # specify the previously estimated regression
        data.frame(chronic=2,GENDER=2,T1AGE=2,RACE1=2,ETHNICITY=2,YEARSEDU=2,T0IMRD=2,T0DLRC=2,T0SER7=2,T0VOCAB=2,T0MSTOT=2,T0CESD=2,T0ADLA=2,T0MOBILA=2,T0LGMUSA=2,T0GROSSA=2,T0ATOTN=2,T0BMI=2,T0HIBP=2,T0DIAB=2,T0LUNG=2,T0CANCR=2,T0HEART=2,T0STROK=2,T0PSYCH=2,T1IMRD=2,T1DLRC=2,T1SER7=2,T1VOCAB=2,T1MSTOT=2,T1CESD=2,T1ADLA=2,T1MOBILA=2,T1LGMUSA=2,T1GROSSA=2,T1ATOTN=2,T1BMI=2,T1PSYCH=2),   #change4; here we specify for women only (at these values)
        type = "response")

# From un-regularized to regularized model: LASSO

# imputation
variable_keep1<-c("GENDER","T1AGE","RACE1","ETHNICITY","YEARSEDU","T0IMRD","T0DLRC","T0SER7","T0VOCAB","T0MSTOT","T0CESD","T0ADLA","T0MOBILA","T0LGMUSA","T0GROSSA","T0ATOTN","T0BMI","T0HIBP","T0DIAB","T0LUNG","T0CANCR","T0HEART","T0PSYCH","T1IMRD","T1DLRC","T1SER7","T1VOCAB","T1MSTOT","T1CESD","T1ADLA","T1MOBILA","T1LGMUSA","T1GROSSA","T1ATOTN","T1BMI","T1PSYCH","T3_DefAlive") #change1
variable_keep2<-c("GENDER","T1AGE","RACE1","ETHNICITY","YEARSEDU","T0IMRD","T0DLRC","T0SER7","T0VOCAB","T0MSTOT","T0CESD","T0ADLA","T0MOBILA","T0LGMUSA","T0GROSSA","T0ATOTN","T0BMI","T0HIBP","T0DIAB","T0LUNG","T0CANCR","T0HEART","T0PSYCH","T3_DefAlive")
